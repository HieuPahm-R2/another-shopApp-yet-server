...
public class MessageKey {
    ...
    public static final String INSERT_CATEGORY_SUCCESSFULLY = "category.create_category" +
            ".create_successfully";
    public static final String DELETE_CATEGORY_SUCCESSFULLY = "category.delete_category" +
            ".delete_successfully";
    public static final String UPDATE_CATEGORY_SUCCESSFULLY = "category.update_category" +
            ".update_successfully";
    public static final String DELETE_ORDER_SUCCESSFULLY = "order.delete_order.delete_successfully";
    public static final String DELETE_ORDER_DETAIL_SUCCESSFULLY = "order.delete_order_detail" +
            ".delete_successfully";
    ...
    public static final String UPLOAD_IMAGES_FILE_MUST_BE_IMAGE = "product.upload_images" +
            ".file_must_be_image";
